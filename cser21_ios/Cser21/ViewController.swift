...
//        let h = view.bounds.height ;//- mtop
    ...
    override func viewDidLoad() {
        ...
        UIApplication.shared.statusBarUIView?.backgroundColor = #colorLiteral(red: 0.02352941176, green: 0.2196078431, blue: 0.2156862745, alpha: 1)
//
//        if #available(iOS 11.0, *) {
